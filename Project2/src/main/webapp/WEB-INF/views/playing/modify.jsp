...
<div class="container">
	...
	<section>
		<form role="form" action="/playing/modify" method="post">
		...
		<input type="hidden" name="keyword" value="${pageMaker.cri.keyword }">
			...
			<table>
				...
				<tr>
					<td class="titleTd">
						<input type="text" name="title" value="<c:out value='${pboard.title }'/>">
					</td>
				</tr>
				...
				<tr>
					<td class="titleTd">
						<input type="text" name="link" value="<c:out value='${pboard.link }'/>">
					</td>
				</tr>
				...
				<tr>
					<td>
						<textarea rows="31" name="content"><c:out value='${pboard.content }'/></textarea>
					</td>
				</tr>
				
				<tr>
					<td class="tdlabel" id="regBtnTd">
						<input type="hidden" name="bno" value="<c:out value='${pboard.bno }'/>">
