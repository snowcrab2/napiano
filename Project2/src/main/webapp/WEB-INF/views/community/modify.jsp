	...
	<section>
		...
		<input type="hidden" name="keyword" value="${pageMaker.cri.keyword }">
			...
			<table>
				...
				<tr>
					<td class="titleTd">
						<input type="text" name="title" value="<c:out value='${cboard.title }'/>">
					</td>
				</tr>
				...
				<tr>
					<td>
						<textarea rows="31" name="content"><c:out value='${cboard.content }'/></textarea>
					</td>
				</tr>
				
				<tr>
					<td class="tdlabel" id="regBtnTd">
						<input type="hidden" name="bno" value="<c:out value='${cboard.bno }'/>">
